...
public final class LoginRequest extends
    ...
    getDescriptor() {
        return Mahjong.internal_static_LoginRequest_descriptor;
    }

    protected FieldAccessorTable
    internalGetFieldAccessorTable() {
        return Mahjong.internal_static_LoginRequest_fieldAccessorTable
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
        ...
        if (!getUsernameBytes().isEmpty()) {
            writeString(output, 1, username_);
        }
        if (!getPasswordBytes().isEmpty()) {
            writeString(output, 2, password_);
        }
    }
    ...
    public int getSerializedSize() {
        ...
        size = 0;
        if (!getUsernameBytes().isEmpty()) {
            size += computeStringSize(1, username_);
        }
        if (!getPasswordBytes().isEmpty()) {
            size += computeStringSize(2, password_);
        }
        memoizedSize = size;
        return size;
    }
    ...
    public static final class Builder extends
        ...
        // Construct using com.geekerstar.netty.mooc.core.$997.proto.LoginRequest.newBuilder()
        private Builder() {
